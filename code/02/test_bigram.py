...
def test_unigram():
	...
	for unigram_known_word_freq in [round(0.01*x, 2) for x in range(5, 100, 5)]:
		for bigram_known_word_freq in [round(0.01*x, 2) for x in range(5, 100, 5)]:
			...
			if gold_entropy < all_entropy:
				gold_entropy = all_entropy
				gold_unigram_known_word_freq = unigram_known_word_freq
				gold_bigram_known_word_freq = bigram_known_word_freq

	print gold_entropy, coverage, gold_unigram_known_word_freq, gold_bigram_known_word_freq
